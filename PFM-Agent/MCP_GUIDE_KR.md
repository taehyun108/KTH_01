# 🔌 PFM-Agent MCP 구조 가이드 (개발자용)

이 문서는 **다른 개발자가 PFM-Agent에 새 도구를 추가**할 수 있도록 MCP 구조를 설명합니다.
...
따라서 PFM-Agent 는 두 가지 이름을 구분해서 사용한다.
