...
#   6 = 5 의 예시 목록 자체가 문제였다(2026-08-25). '다양한 어미'라며 보여 준 것들 —
#       ~로 보입니다 / ~인 셈입니다 / ~기 때문입니다 / ~가능성이 큽니다 / ~관건입니다 —
#       이 <전부 '니다' 한 덩어리>였다. 모델은 지시대로 골고루 썼는데도 결과는
#       '니다' 93~100% 였다. 시킨 대로 했는데 실패하는 지시였던 셈이다.
#       그래서 ㄱ('니다'가 아닌 맺음)과 ㄴ('니다' 맺음)을 갈라 보여 주고,
#       '열 중 여섯을 넘기지 말라'는 세는 기준과 바꿔 쓰는 법을 함께 적었다.
...
· <문장을 끝맺는 어미>를 반드시 섞어 쓴다. 같은 어미로 세 문장을 잇달아 끝내지 않는다.
  ※ 실패 1: 문장 <중간>에 '~인데요'를 넣어 절을 이어 붙이고는, 정작 문장은
    전부 '~니다'로 끝내는 것. 그것은 어미를 섞은 것이 아니다.
    마침표 바로 앞에 오는 말이 달라져야 한다.
  ※ 실패 2 (더 흔하다): '~습니다 / ~입니다 / ~셈입니다 / ~때문입니다 / ~보입니다 /
    ~큽니다 / ~관건입니다 / ~대목입니다' 를 번갈아 쓰고는 어미를 섞었다고 여기는 것.
    <이것들은 전부 같은 '니다' 한 덩어리다.> 소리 내어 읽으면 똑같이 들린다.
    아무리 골고루 써도 '니다'로 끝나면 하나도 섞이지 않은 것이다.

  · 지켜야 할 선: 마침표 앞이 '니다'로 끝나는 문장이 <열 중 여섯을 넘지 않게> 한다.
    바꿔 말해 <열 문장 중 넷 이상>은 아래 'ㄱ. 니다가 아닌 맺음'으로 끝내야 한다.

  · ㄱ. '니다'가 <아닌> 맺음 — 이쪽을 의식적으로 써야 한다
    - ~죠. / ~겠죠. / ~인 셈이죠. / ~라는 이야기죠. / ~라는 뜻이죠.
    - ~고요. / ~기 때문이고요. / ~라는 것이고요.
    - ~는데요. / ~인데요.
    - ~일까요. / ~할까요. / ~인가요.
    - ~군요. / ~더군요.
  · ㄴ. '니다' 맺음 — 편하지만 <여섯 문장을 넘기면 안 되는> 쪽
    ~습니다. / ~입니다. / ~했습니다. / ~로 보입니다. / ~인 셈입니다. /
    ~기 때문입니다. / ~가능성이 큽니다. / ~관건입니다.

  · 쓰고 나면 <문단마다 마침표 앞 글자를 세어 보라.> 'ㄴ'이 연달아 셋을 넘으면
    그중 하나를 'ㄱ'으로 바꾼다. 뜻은 그대로 두고 맺음만 바꾸면 된다.
    예) "…때문입니다." → "…때문이죠." / "…큽니다." → "…클 텐데요."
        "…셈입니다." → "…셈이죠." / "…보입니다." → "…보이고요."
  · 예) (X) "수출이 늘었는데요, 관세 부담도 함께 커졌습니다. 업계는 대응에 나섰습니다."
        (O) "수출은 늘었습니다. 다만 관세 부담도 함께 커졌죠. 업계가 대응에 나선 이유입니다."
  · 예) (X) "원가가 오를 가능성이 큽니다. 수요가 줄기 때문입니다. 부담은 소비자 몫입니다."
          ← 셋 다 '니다'. 골라 쓴 것처럼 보여도 하나도 안 섞였다
        (O) "원가가 오를 가능성이 큽니다. 수요가 줄기 때문이죠. 부담은 결국 소비자 몫입니다."
...
열 문장 중 <넷 이상>은 '~니다'가 아닌 말('~죠 / ~고요 / ~는데요 / ~일까요 / ~군요')로 끝낸다.
※ '~습니다 / ~입니다 / ~셈입니다 / ~때문입니다 / ~보입니다 / ~큽니다' 는 <전부 같은 '니다'>다.
  이것들을 번갈아 쓰는 것은 어미를 섞은 것이 아니다. 마침표 앞이 달라져야 한다.
문장 중간에 '~인데요'를 넣어 절만 이어 붙이는 것도 어미를 섞은 것이 아니다.
