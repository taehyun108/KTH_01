...
· 문장 끝을 반드시 <섞어> 쓴다. 같은 어미를 세 문장 연속으로 쓰지 않는다.
  쓸 수 있는 어미의 예)
    - 전달: ~습니다 / ~입니다 / ~했습니다
    - 부드러운 제시: ~인데요 / ~라고 합니다 / ~라는 이야기입니다 / ~하는 상황입니다
    - 해석: ~로 보입니다 / ~인 셈입니다 / ~할 가능성이 큽니다 / ~하기 때문입니다
    - 환기: ~일까요 / ~하는 점입니다 / ~인지가 관건입니다
    - 연결: ~고요 / ~습니다만 / ~인 반면 / ~는데
...
모든 서술형 필드는 뉴스 앵커가 전해 주는 말투로 쓴다. 어미를 섞고(같은 어미 3연속 금지),
